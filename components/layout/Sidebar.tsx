    ...
    <div className="flex flex-col h-full">
      ...
      <nav className="flex-1 p-2 space-y-px overflow-y-auto">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <span className={isActive ? 'text-[#111111]' : 'text-[#555]'}>{item.icon}</span>
      ...
      <div className="p-2 border-t border-white/[0.06] space-y-px">
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-[13px] font-medium text-[#888] hover:text-red-400 hover:bg-white/[0.06] transition-colors"
        >
          <svg className="w-4 h-4 text-[#555]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
