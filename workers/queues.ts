...
export const syncFattureQueue = new Queue('sync-fatture', { connection })
export const alertsQueue = new Queue('alerts', { connection })
export const syncContactsQueue = new Queue('sync-contacts', { connection })
export const syncTasksQueue = new Queue('sync-tasks', { connection })
